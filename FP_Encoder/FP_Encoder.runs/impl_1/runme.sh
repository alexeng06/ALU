...
HD_PWD='C:/Users/xenia/Desktop/FP_Encoder/FP_Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_Encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPU_Encoder.tcl -notrace
