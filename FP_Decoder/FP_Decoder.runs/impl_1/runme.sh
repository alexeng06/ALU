...
HD_PWD='C:/Users/xenia/Desktop/FP_Decoder/FP_Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPU_decoder.tcl -notrace
