...
HD_PWD='C:/Users/xenia/Desktop/FP_Decoder/FP_Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPU_decoder.tcl
