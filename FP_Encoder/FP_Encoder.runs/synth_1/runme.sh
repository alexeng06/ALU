...
HD_PWD='C:/Users/xenia/Desktop/FP_Encoder/FP_Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPU_Encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPU_Encoder.tcl
